...
| Embarkation/Disembark<br>ation time convenient | * Assume 0 (not in importance scale) to be missing data                                                                                                                 | -                                                  | * Missing data filled with median after grouping by possibly related variables |
